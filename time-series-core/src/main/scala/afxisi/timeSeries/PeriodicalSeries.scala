...
import afxisi.timeSeries.PeriodicalSeries.condensePartial
import afxisi.timeSeries.time.Periodical.{Daily, Include}
...
case class PeriodicalSeries[TS[_], P <: Periodical, Z <: Zone, A] private[timeSeries] (
  ...
  /**
    ...
    * scala> import afxisi.timeSeries._, time._, Periodical._
    * scala> import afxisi.timeSeries.testUtil._
    *
