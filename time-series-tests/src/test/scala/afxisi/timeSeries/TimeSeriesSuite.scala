...
import afxisi.timeSeries.syntax.TimeSeriesSyntax
import afxisi.timeSeries.testUtil.{Assertions, Factory}
import afxisi.timeSeries.time.{FreePeriod, Periodical}
